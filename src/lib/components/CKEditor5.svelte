<script>
          ...
          html: (match) => {
            ...
            return `<blockquote class="instagram-media"
                      ...
                      <div style="padding:16px;">
                        <a href="//www.instagram.com/reel/${id}/?utm_source=ig_embed&amp;utm_campaign=loading"
  ...
  <div style="padding:16px;"> <a
    ...
    <p
      ...
      <a href="https://www.instagram.com/p/${id}/?utm_source=ig_embed&amp;utm_campaign=loading"
  ...
  onMount(async () => {
    ...
    try {
      ...
      DecoupledEditor = (
        await import('@ckeditor/ckeditor5-build-decoupled-document/build/ckeditor')
      ).default;
      
      console.log('CKEditor loaded:', DecoupledEditor);
      
      if (!DecoupledEditor) {
        throw new Error('CKEditor DecoupledEditor is undefined');
      }
